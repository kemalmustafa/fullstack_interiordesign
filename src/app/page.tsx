    ...
    <div style={{ backgroundColor: '#F7F3EE' }} className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
        ...
        <div className="relative overflow-hidden" style={{ minHeight: '60vh' }}>
          ...
          />
          {/* Hafif overlay */}
          <div className="absolute inset-0" style={{ background: 'linear-gradient(to right, transparent 60%, #F7F3EE)' }} />
        </div>

        {/* Sağ: Metin */}
        <div className="flex flex-col justify-center px-12 md:px-16 py-24" style={{ backgroundColor: '#F7F3EE' }}>
          ...
          <h1 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 'clamp(44px, 5vw, 72px)', fontWeight: 300, lineHeight: 1.05, color: '#2C2218', marginBottom: '12px' }}>
            Räume, die
          </h1>
          ...
          <div className="flex items-center gap-6">
            <a href="/projects" style={{ fontSize: '10px', letterSpacing: '0.4em', textTransform: 'uppercase', fontWeight: 300, padding: '14px 32px', border: '1px solid #2C2218', color: '#2C2218', backgroundColor: 'transparent', textDecoration: 'none' }}
              className="hover:bg-[#2C2218] hover:text-[#F7F3EE] transition-all duration-300">
              Projekte ansehen
            </a>
            <a href="/about" style={{ fontSize: '10px', letterSpacing: '0.3em', textTransform: 'uppercase', fontWeight: 200, color: '#B5A08A', textDecoration: 'none' }}
      ...
      <div style={{ backgroundColor: '#F0EAE1', borderTop: '1px solid #E2D9CE', borderBottom: '1px solid #E2D9CE' }}>
        <div className="max-w-7xl mx-auto px-8 py-10 grid grid-cols-3 gap-8 text-center">
          {[
            ...
            <div key={item.etiket}>
              <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '36px', fontWeight: 300, color: '#2C2218', lineHeight: 1 }}>
                {item.sayi}
              </p>
      ...
      {/* ALT — Yaklaşım */}
      <div className="max-w-7xl mx-auto px-8 py-28 grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
        <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          {[
            ...
            <div key={kart.baslik} style={{ backgroundColor: '#F0EAE1', border: '1px solid #E2D9CE', borderRadius: '4px', padding: '20px' }}
