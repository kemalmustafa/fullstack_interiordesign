...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const res = await fetch('https://formspree.io/f/xzdjvbqb', {
      method: 'POST',
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="focus:border-b-[#8B7055] placeholder:text-[#C4B09A] placeholder:text-sm transition-colors duration-200"
                    />
                  </div>
                  <div className="space-y-2">
                    <label style={{ fontSize: '10px', letterSpacing: '0.3em', textTransform: 'uppercase', color: '#B5A08A', fontWeight: 300, display: 'block' }}>
