        ...
        <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-start">
            ...
            <div className="md:col-span-4" style={{ position: 'sticky', top: '120px' }}>
              <div style={{ backgroundColor: '#F0EAE1', border: '1px solid #E2D9CE', borderRadius: '12px', padding: '32px', marginBottom: '24px' }}>
              ...
              <a href="/contact"
                style={{ display: 'block', textAlign: 'center', padding: '14px', border: '1px solid #C4B09A', borderRadius: '4px', fontSize: '10px', letterSpacing: '0.4em', textTransform: 'uppercase', color: '#8B7055', textDecoration: 'none', fontWeight: 300 }}
            ...
            <div className="md:col-span-8">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', marginBottom: '64px' }}>
                <p style={{ fontSize: '15px', fontWeight: 200, color: '#4A3728', lineHeight: 1.9 }}>
                  ...
                  Seit meinem Abschluss an der <strong style={{ fontWeight: 400 }}>Technischen Universität Eskişehir</strong> verleihe ich Räumen eine einzigartige Identität.
                </p>
                <p style={{ fontSize: '15px', fontWeight: 200, color: '#4A3728', lineHeight: 1.9 }}>
              ...
              <div style={{ borderTop: '1px solid #E2D9CE', paddingTop: '48px' }}>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={kart.baslik}
                      style={{ backgroundColor: '#F0EAE1', border: '1px solid #E2D9CE', borderRadius: '6px', padding: '20px 24px' }}
